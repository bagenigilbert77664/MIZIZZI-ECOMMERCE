  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setIsSuccess(true)
        setTransactionId(`MP${Math.floor(Math.random() * 1000000000)}`)
    ...
    <div className="space-y-6">
      ...
      {!isSuccess ? (
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-center mb-6">
            <Smartphone className="h-12 w-12 mx-auto text-green-600 mb-3" />
            <h3 className="text-xl font-bold text-gray-900 mb-2">M-Pesa Payment</h3>
            <p className="text-gray-600">Enter your M-Pesa registered phone number to pay {formatPrice(amount)}</p>
          </div>
          ...
          {!isPinRequested ? (
            ...
            <div className="text-center py-8">
              ...
              <div className="text-sm text-gray-500 max-w-xs mx-auto">
                Please enter your M-Pesa PIN on your phone to complete the payment of {formatPrice(amount)}
              </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm text-center">
          ...
          <p className="text-gray-600 mb-4">
            Your M-Pesa payment of {formatPrice(amount)} has been processed successfully.
          </p>
      ...
      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
        ...
        <p className="text-sm text-gray-600">
          Your payment information is securely processed. We do not store your M-Pesa PIN.
        </p>
      </div>
    </div>
  )
