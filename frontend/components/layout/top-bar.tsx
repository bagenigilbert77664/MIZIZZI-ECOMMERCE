...
const announcements = [
  {
    ...
    image: "https://images.unsplash.com/photo-1530545124313-ce5e8eae55af?w=1200&h=200&fit=crop&q=80",
    contact: {
      icon: Phone,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1532886088761-148f6df5ec52?w=1200&h=200&fit=crop&q=80",
    contact: {
      icon: MapPin,
    ...
    return (
      <div className="relative bg-gradient-to-r from-gray-950 via-gray-900 to-gray-950 text-white">
        <div className="container mx-auto">
          <div className="flex h-10 xs:h-12 items-center justify-center px-2 xs:px-4">
  ...
  return (
    <div className="relative bg-gradient-to-r from-gray-950 via-gray-900 to-gray-950 text-white overflow-hidden">
      ...
      <div className="container mx-auto relative">
        <div className="flex h-10 xs:h-12 sm:h-12 md:h-14 items-center justify-between px-2 xs:px-4">
          {/* Left side - Contact Info */}
          <div className="flex-shrink-0 w-0 xs:w-auto">
            <AnimatePresence mode="wait">
              <motion.div
          ...
          {/* Center - Announcement */}
          <div className="flex-1 relative h-5 xs:h-6 sm:h-6 md:h-7 overflow-hidden text-center perspective-1000 mx-2 xs:mx-4 sm:max-w-xl sm:mx-auto">
            <AnimatePresence mode="wait">
