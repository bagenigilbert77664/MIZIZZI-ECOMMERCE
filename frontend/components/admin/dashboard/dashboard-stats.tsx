...
export function DashboardStats({ data, sales, orderStatus = {} }: DashboardStatsProps) {
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
      {/* Revenue Card */}
      <div className="group relative overflow-hidden rounded-xl bg-white transition-all duration-300 hover:translate-y-[-5px] hover:shadow-xl dark:bg-gray-800">
        ...
        <CardContent className="p-6">
          ...
          <div className="flex items-center">
            {pendingOrders > 0 ? (
              ...
              <div className="flex items-center rounded-full bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-800 dark:bg-gray-700 dark:text-gray-300">
                No pending orders
              </div>
            )}
          </div>
