...
export function Overview({ salesData = [] }: OverviewProps) {
  ...
  if (!Array.isArray(salesData) || salesData.length === 0) {
    ...
    return (
      <>
        ...
        <CardContent>
          <div className="w-full h-[350px] min-h-[350px] min-w-[300px] rounded-lg bg-gray-50 dark:bg-gray-800/50 flex items-center justify-center p-6">
  ...
  return (
    <>
      ...
      <CardContent>
        <div className="w-full h-[350px] min-h-[350px] min-w-[300px]">
          <ResponsiveContainer width="100%" height="100%" minWidth={300} minHeight={350}>
