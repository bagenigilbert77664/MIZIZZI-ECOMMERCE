      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => router.push("/mizizzi_admin/profile")}>Profile</DropdownMenuItem>
            <DropdownMenuItem onClick={() => router.push("/mizizzi_admin/settings")}>Settings</DropdownMenuItem>
            <DropdownMenuSeparator />
