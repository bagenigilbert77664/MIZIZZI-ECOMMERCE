...
import { MoreHorizontal, Eye, FileText, Download, RefreshCw, Mail, ArrowLeft, CheckCircle } from "lucide-react"
...
export default function CompletedOrdersPage() {
  ...
  const handleRefresh = async () => {
    ...
    toast({
      title: "Success",
      description: "Completed orders refreshed successfully",
    })
  }
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">View all successfully delivered orders</p>
          </div>
        </div>
