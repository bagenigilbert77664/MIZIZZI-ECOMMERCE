...
export default function ProcessingOrdersPage() {
  ...
  const fetchOrders = useCallback(async () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to load processing orders. Please try again.",
        variant: "destructive",
      })
    } finally {
      setIsLoading(false)
  ...
  const handleRefresh = async () => {
    ...
    toast({
      title: "Success",
      description: "Processing orders refreshed successfully",
    })
  }
                          ...
                          <TableCell className="text-right">
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem
                                  onClick={() =>
                                    adminService.updateOrderStatus(order.id, { status: "shipped" }).then(() => {
