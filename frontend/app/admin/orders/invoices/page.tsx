...
import { MoreHorizontal, Eye, FileText, Download, RefreshCw, Mail, ArrowLeft, Receipt } from "lucide-react"
...
export default function InvoicesPage() {
  ...
  const fetchOrders = useCallback(async () => {
    try {
      ...
      const params: any = {
        page: currentPage,
        per_page: 15,
        payment_status: "paid", // Only show paid orders for invoices
      }
  ...
  const handleRefresh = async () => {
    ...
    toast({
      title: "Success",
      description: "Invoices refreshed successfully",
    })
  }
    ...
    <div className="flex flex-col gap-6">
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex items-center gap-4">
            <Input
              placeholder="Search invoices by order number, customer name, or email..."
              value={searchTerm}
