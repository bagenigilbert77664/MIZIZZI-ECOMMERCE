...
import { MoreHorizontal, Eye, FileText, Download, RefreshCw, Mail, ArrowLeft, XCircle } from "lucide-react"
...
export default function CancelledOrdersPage() {
  ...
  const fetchOrders = useCallback(async () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to load cancelled orders. Please try again.",
        variant: "destructive",
      })
    } finally {
      setIsLoading(false)
  ...
  const handleRefresh = async () => {
    ...
    toast({
      title: "Success",
      description: "Cancelled orders refreshed successfully",
    })
  }
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">View all cancelled orders and refunds</p>
          </div>
        </div>
