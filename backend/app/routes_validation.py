...
@validation_routes.route('/admin/dashboard', methods=['GET', 'OPTIONS'])
@cross_origin()
@admin_required
def admin_dashboard():
...
@validation_routes.route('/admin/users', methods=['GET', 'OPTIONS'])
@cross_origin()
@admin_required
def admin_get_users():
...
@validation_routes.route('/admin/orders', methods=['GET', 'OPTIONS'])
@cross_origin()
@admin_required
