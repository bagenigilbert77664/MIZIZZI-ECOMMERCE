...
def create_app(config_name=None, enable_socketio=True):
    ...
    CORS(
        ...
        allow_headers=["Content-Type", "Authorization", "X-Requested-With", "Cache-Control", "Pragma", "Expires", "X-MFA-Token", "Accept", "Origin"],
    ...
    def handle_preflight():
        if request.method == "OPTIONS":
            ...
            response.headers.add('Access-Control-Allow-Headers', "Content-Type,Authorization,X-Requested-With,Cache-Control,Pragma,Expires,X-MFA-Token,Accept,Origin")
    ...
    # Add fallback route for admin email
    ...
    blueprint_imports = {
        ...
        # ADDED PAYMENT_ROUTES IMPORT PATHS FOR GENERAL PAYMENT ENDPOINTS
        'payment_routes': [
